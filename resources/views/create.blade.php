        ...
        <div class="container box">
            ...
            <div class="row" style="height: 512px; background-color: darkblue;">
                <div class="col-md-6 mb-md-0 mb-5">
                    <form method="post" action="{{ url('sendemail/send') }}" class="p-5">
                    {{ csrf_field() }}
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                <textarea name="message" id="message" name="message" cols="30" rows="7" class="form-control" placeholder="Write your notes here..."></textarea>
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col-md-6">
